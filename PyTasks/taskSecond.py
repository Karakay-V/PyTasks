def taskSecond():
    ...
    # ЦИКЛ З ПЕРЕБОРОМ МАССИВУ З МІСЯЦЯМИ ДЛЯ ВИВОДУ
    for i in months:
        print(" " + str(i))

    print(
        "\n"+"\\---------------------ВИСНОВКИ---------------------//" +
        "\nПід час виконання цієї лабораторної роботи я використав всього лиш массив з об'єктами місяцями та вивів їх циклом."
    )
    return months

    # ПОМИЛКОВО ПОЧАВ РОБИТИ ІНШІ ЗАВДАННЯ...
    # ВИДАЛЯТИ ШКОДА(
